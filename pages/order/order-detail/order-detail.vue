            ...
            <view class="prod-info">
              ...
              <view class="price-nums clearfix">
                <text class="prodprice"><text class="symbol">￥</text>
                  <text class="big-num">{{(item.price)[0]}}</text>
                  <text class="small-num">.{{(item.price)[1]}}</text></text>
                <view class="btn-box">
        ...
        <view class="msg-item">
          <view class="item">
            ...
            <view class="item-txt price">
              ...
              <text class="big-num">{{(total)[0]|parsePrice}}</text>
              <text class="small-num">.{{(total)[1]|parsePrice}}</text>
            </view>
          </view>
          <view class="item">
            ...
            <view class="item-txt price">
              <text class="symbol">￥</text>
              <text class="big-num">{{(transfee)[0]|parsePrice}}</text>
              <text class="small-num">.{{(transfee)[1]|parsePrice}}</text>
            </view>
          </view>
          <view class="item">
            ...
            <view class="item-txt price">
              <text class="symbol">-￥</text>
              <text class="big-num">{{(reduceAmount)[0]|parsePrice}}</text>
              <text class="small-num">.{{(reduceAmount)[1]|parsePrice}}</text>
            </view>
          </view>
          <view class="item payment">
            <view class="item-txt price">
              实付款：
              <text class="symbol">￥</text>
              <text class="big-num">{{(actualTotal)[0]|parsePrice}}</text>
              <text class="small-num">.{{(actualTotal)[1]|parsePrice}}</text>
            </view>
          </view>
        </view>
      </view>
