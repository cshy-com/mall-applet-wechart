  ...
  <view>
    <view class="select">
      <view class="select1">
        <view class="order">
          <view
            :class="{ cur: curIndex == index, active1: curIndex == index }"
            :key="item.id"
      ...
      <view
        ...
        :key="index"
        class="order1-1"
        style="height: 650rpx; overflow: auto"
      >
        <view class="order1">
          <view
            @click="selectItem(index1, index)"
            :class="{ active: item1.status }"
...
@font-face {
  ...
  src: url('https://at.alicdn.com/t/font_2453967_lwt4zfkc2c.eot?#iefix')
    ...
    url('https://at.alicdn.com/t/font_2453967_lwt4zfkc2c.ttf')
      format('truetype'),
    url('https://at.alicdn.com/t/font_2453967_lwt4zfkc2c.svg#iconfont')
      format('svg');
}
.select {
  width: 100%;
